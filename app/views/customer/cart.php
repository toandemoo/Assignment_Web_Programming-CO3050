                ...
                <form action="<?= ROOT ?>payment" method="post">    
                    ...
                    <div class="text-right total-price">
                        ...
                        <div class="cart-btns">
                            ...
                            <button type="submit" class="btn btn-primary" id="payment-btn" style="display: none;">
...
<script>
    ...
    const paymentButton = document.getElementById('payment-btn'); // Nút thanh toán
    let totalPrice = 0;
    ...
    if (checkboxes.length > 0) {
        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                ...
                updatePaymentButtonVisibility(); // Cập nhật lại tình trạng hiển thị nút thanh toán
            });
        });
    }

    // Hàm kiểm tra và cập nhật tình trạng hiển thị nút thanh toán
    function updatePaymentButtonVisibility() {
        const selectedProducts = document.querySelectorAll('.product-checkbox:checked');
        if (selectedProducts.length > 0) {
            paymentButton.style.display = 'inline-block'; // Hiển thị nút thanh toán
        } else {
